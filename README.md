...
*Turn your Mac, microphone, and headphones into an instant professional stage In-Ear Monitor (IEM) system with real-time vocal processing and master recording.*
...
```bash
git clone https://github.com/YOUR_USERNAME/vocal-cue.git
cd vocal-cue
```
